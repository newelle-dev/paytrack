                ...
                <TableRow key={borrower.id} className="group">
                  ...
                  <TableCell>
                    <div className="flex flex-col text-xs text-text-secondary space-y-0.5">
                      ...
                      {borrower.phone_number && <span>{borrower.phone_number}</span>}
                      {!borrower.email && !borrower.phone_number && <span>No contact info</span>}
                    </div>
                  </TableCell>
                  <TableCell className="text-center">
                    {borrower.active_loans_count > 0 ? (
                      <Badge variant="default" className="bg-gold text-white font-mono rounded">
