...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gold disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gold text-white hover:bg-gold-dark shadow-sm",
        outline: "border border-gold text-gold hover:bg-gold hover:text-white",
        secondary: "bg-ivory-cream text-text-primary hover:bg-ivory shadow-sm",
        ghost: "hover:bg-ivory-cream text-text-primary",
